...
const StudentFeeProfile = () => {
  ...
  const handlePay = (fee) =>
    navigate(`/accountant/fees-payment/collect/${studentId}`, {
  ...
  if (error && !studentInfo) return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="bg-white rounded-2xl shadow-lg p-10 text-center max-w-md w-full border border-gray-200">
        ...
        {/* ✅ FIXED: /admin → /accountant */}
        <button onClick={() => navigate('/accountant/fees-payment/collect')}
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-1 flex-wrap">
              ...
              {studentInfo?.joined_on && (
                <span className="text-sm text-gray-500">📅 Joined {fmtDate(studentInfo.joined_on)}</span>
              )}
            </div>
          </div>
        </div>
          ...
          <>
            {paymentHistory.length === 0 ? (
              ...
              <>
                <div className="grid grid-cols-12 gap-2 px-6 py-3 bg-gray-50 border-b border-gray-100">
                  {[
                    { h: 'Fee Head', s: 'col-span-4' }, { h: 'Type',   s: 'col-span-2' },
                    { h: 'Date',     s: 'col-span-2' }, { h: 'Mode',   s: 'col-span-2' },
          ...
          <div className="modal-enter bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-100">
            ...
            <div className="px-6 pb-5 flex items-center justify-end gap-3">
              <button onClick={closeModal} disabled={discLoading}
                className="px-5 py-2.5 rounded-lg border border-gray-200 font-semibold text-gray-700 text-sm hover:bg-gray-50 disabled:opacity-50">
                Cancel
              </button>
