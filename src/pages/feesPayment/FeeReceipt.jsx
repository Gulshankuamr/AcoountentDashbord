...
const FeeReceipt = () => {
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      navigate('/accountant/fees-payment/collect', { replace: true });
    }
  }, []);
  ...
  const handleDone = () => {
    ...
    navigate('/accountant/fees-payment/collect');
  };
    ...
    <div className="min-h-screen bg-gray-100 py-8 px-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="max-w-2xl mx-auto">
              ...
              <tbody className="divide-y divide-gray-50">
                ...
                {lateCharge > 0 && (
                  <tr>
                    ...
                    <td className="py-3 px-3 text-center"><span className="text-xs text-red-600">Fine</span></td>
        ...
        <div className={`no-print mt-5 space-y-3 fade-up transition-all duration-500 delay-200 ${visible ? 'opacity-100' : 'opacity-0'}`}>
          ...
          {/* ✅ FIXED: /admin → /accountant via handleDone */}
