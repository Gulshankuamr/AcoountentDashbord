...
const CollectFee = () => {
  ...
  // ✅ FIXED: /admin → /accountant
  const handleCollect = (student) =>
    navigate(`/accountant/fees-payment/student/${student.student_id}`);
    ...
    <div className="min-h-screen bg-gray-50" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h2 className="font-bold text-gray-900 text-base">Fee Collection — Students</h2>
        ...
        <div className="grid grid-cols-12 gap-3 px-6 py-3 bg-gray-50 border-b border-gray-100">
          {[
            ...
            { label: 'Admission No', span: 'col-span-4' },
            { label: 'Action',       span: 'col-span-3 text-right' },
          ].map(({ label, span }) => (
                ...
                <div key={student.student_id}
                  ...
                  <div className="col-span-5 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {student.class_name && (
                        <p className="text-xs text-gray-400">{student.class_name} — {student.section_name}</p>
                      )}
                    </div>
                  </div>
        ...
        {filteredStudents.length > 0 && (
          <div className="px-6 py-3 border-t border-gray-100 bg-gray-50 flex items-center justify-between">
            <span className="text-xs text-gray-500">
              Showing {Math.min(filteredStudents.length, 10)} of {filteredStudents.length} entries
            </span>
            <div className="flex items-center gap-1">
              ...
              <button className="w-8 h-8 flex items-center justify-center rounded border border-gray-200 text-gray-700 hover:border-orange-400 hover:text-orange-500 text-sm transition-colors">›</button>
            </div>
          </div>
        )}
      </div>
